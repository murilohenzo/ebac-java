...
public class SingletonPropertiesThreadSync {
    ...
    static class ThreadFoo implements Runnable {
        ...
        @Override
        public void run() {
            SingletonPropertiesSync singletonProperties = SingletonPropertiesSync.getInstance("teste");
    ...
    static class ThreadBar implements Runnable {
        ...
        @Override
        public void run() {
            SingletonPropertiesSync singletonProperties1 = SingletonPropertiesSync.getInstance("teste1");
